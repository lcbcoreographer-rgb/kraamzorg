 ...
 * então este fica aqui, dentro do módulo, para os filtros e o cadastro
 * manual de lead (P15). Se outro módulo precisar do mesmo desenho, dá para
 * promover para `src/components/ui` depois.
 */
